...
namespace OpenTK_winforms_z01 {
    public partial class OpenGLWnd : Form {
        ...
        private float rotationAngle = 0.0f; // Unghiul de rotație

        float[] lightPosition = { 0.0f, 0.0f, 1.0f, 1.0f }; // Poziția luminii
        float[] lightColor = { 1.0f, 1.0f, 1.0f, 1.0f }; // Culoarea luminii
        ...
        protected override void OnLoad(EventArgs e) {
            rotationAngle += 0.5f; // Rotează cu 0.5 grade pe cadru
        ...
        private void DrawTriangle() {
            ...
            GL.Rotate(rotationAngle, 0.0f, 1.0f, 0.0f); // Roteste obiectul pe axa Y
            GL.End();
        }
